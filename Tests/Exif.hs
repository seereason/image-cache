...
tests =
    TestList
      [ test' 1 (pack "") (Left (ErrorCall "Data.Binary.Get.runGet at position 0: not enough bytes"))
      , test' 7 (pack "abcd") (Left (ErrorCall "Data.Binary.Get.runGet at position 4: Invalid JPEG header: [97,98,99,100]"))
      , test' 2 (pack "\255\216\255\225") (Left (ErrorCall "Data.Binary.Get.runGet at position 4: not enough bytes"))
      , test' 3 (pack "\255\216\255\225}\254") (Left (ErrorCall "Data.Binary.Get.runGet at position 6: not enough bytes"))
      , test' 8 (pack "\255\216\255\225}\254Exim\NUL\NUL") (Left (ErrorCall "Data.Binary.Get.runGet at position 12: Invalid EXIF header: [69,120,105,109,0,0]"))
      , test' 4 (pack "\255\216\255\225}\254Exif\NUL\NUL") (Left (ErrorCall "Data.Binary.Get.runGet at position 12: not enough bytes"))
      , test' 9 (pack "\255\216\255\225}\254Exif\NUL\NULMI") (Left (ErrorCall "Data.Binary.Get.runGet at position 14: Invalid byte order: [77,73]"))
