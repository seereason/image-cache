...
import Text.LaTeX.Base.Syntax (Measure(..))
...
test1 =
    TestCase $
      assertEqual
        "includegraphics 1"
        "\\includegraphics[width=3.00000in, trim=1.00000pt 1.00000pt 1.00000pt 1.00000pt, clip]{/srv/appraisalscribe-development/images/c3bd1388b41fa5d956e4308ce518a8bd.png}"
        (render (execLaTeXM (includegraphics (fromList [Trim (Pt 1.0) (Pt 1.0) (Pt 1.0) (Pt 1.0), Clip, Width (measure (In 3.0))])
...
test2 =
    TestCase $
      assertEqual
        ...
        (render
         (execLaTeXM
          (includegraphics (fromList [Width (commS "textwidth")])
                           "/srv/appraisalscribe-development/images/c3bd1388b41fa5d956e4308ce518a8bd.png" <>
           vfill <>
